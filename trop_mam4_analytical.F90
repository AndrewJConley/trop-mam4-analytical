...
!-------------------------------------------------------
      ...
      real(r8), intent(in)    :: HO2, OH, NO3           ! fixed number densities (num / cc)

      ! prognosed number densities (_0 is at the beginning, _t is at the end of the time step
...
!-------------------------------------------------------
      ...
      k(5) = 1.7e-42*exp(7810./temperature)*m*0.21/ko
